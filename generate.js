...
function genKeywordPages(){
  ...
  const KEYWORD_PAGES_LOCAL = [
    ...
    {slug:'metodika-sheiko-pauerlifting', title:'Методика Шейко в пауэрлифтинге — конспект книги', desc:'Конспект методики Б.И. Шейко: техника приседа, жима и тяги, планирование тренировок, экипировка.',h1:'Методика Шейко пауэрлифтинг'},
    {slug:'kniga-sheiko-pauerlifting', title:'Книга Шейко по пауэрлифтингу — главное из методики', desc:'Главное из книги Б.И. Шейко: классификация упражнений, техника, планирование, программы чемпионов.',h1:'Книга Шейко пауэрлифтинг'},
    {slug:'programma-sheiko-dlya-nachinayushchih', title:'Программа Шейко для начинающих — принципы', desc:'Принципы построения программы Шейко для новичков: КПШ, интенсивность, техника, ОФП.',h1:'Программа Шейко для начинающих'},
    {slug:'zaciorskiy-nauka-o-sile', title:'Зациорский — наука о силе, конспект книги', desc:'Конспект книги Зациорского: методы воспитания силы, кривая сила-скорость, дыхание и натуживание.',h1:'Зациорский наука о силе'},
    {slug:'kniga-zaciorskiy-sila', title:'Книга Зациорского про силу — главные идеи', desc:'Главные идеи книги Зациорского: метод максимальных усилий, повторных усилий, динамических усилий.',h1:'Книга Зациорского про силу'},
    {slug:'metod-maksimalnyh-usiliy', title:'Метод максимальных усилий — что это', desc:'Метод максимальных усилий по Зациорскому: работа с весами 85-100% от максимума для роста силы.',h1:'Метод максимальных усилий'},
    {slug:'metod-povtornyh-usiliy', title:'Метод повторных усилий — до отказа', desc:'Метод повторных усилий (до отказа): работа с весом 70-85% на 8-12 повторений для массы и новичков.',h1:'Метод повторных усилий'},
    {slug:'metod-dinamicheskih-usiliy', title:'Метод динамических усилий — взрывная сила', desc:'Метод динамических усилий: облегчённый вес и максимальная скорость для развития взрывной силы.',h1:'Метод динамических усилий'},
    {slug:'kak-rastet-sila-myshc', title:'Как растёт сила мышц — принцип перегрузки', desc:'Принцип перегрузки: почему сила растёт только при стрессе выше привычной адаптации.',h1:'Как растёт сила мышц'},
    {slug:'kriva-sila-skorost', title:'Кривая сила-скорость — закон Хилла', desc:'Кривая сила-скорость (закон Хилла): чем быстрее движение, тем меньше силы проявляет мышца.',h1:'Кривая сила-скорость'},
    {slug:'absolyutnaya-i-otnositelnaya-sila', title:'Абсолютная и относительная сила — разница', desc:'Разница между абсолютной и относительной силой. Что важнее тяжеловесам, а что легковесам.',h1:'Абсолютная и относительная сила'},
    {slug:'dyhanie-i-natuzhivanie-v-pauerliftinge', title:'Дыхание и натуживание в пауэрлифтинге', desc:'Правильное дыхание и натуживание при подъёме тяжестей: вдох, выдох, безопасность.',h1:'Дыхание и натуживание пауэрлифтинг'},
    {slug:'tehnika-priseda-sheiko', title:'Техника приседа по Шейко', desc:'Техника приседа по методике Б.И. Шейко: старт, опускание, подъём, типичные ошибки.',h1:'Техника приседа Шейко'},
    {slug:'tehnika-zhima-sheiko', title:'Техника жима лёжа по Шейко', desc:'Техника жима лёжа по методике Б.И. Шейко: мост, хват, пауза, срыв со груди.',h1:'Техника жима Шейко'},
    {slug:'tehnika-tyagi-sheiko', title:'Техника становой тяги по Шейко', desc:'Техника становой тяги по методике Б.И. Шейко: классика vs сумо, отрыв, фиксация.',h1:'Техника тяги Шейко'},
    {slug:'stil-sumo-ili-klassika', title:'Стиль тяги сумо или классика — что выбрать', desc:'Сравнение стилей становой тяги: сумо и классика. Какой стиль выгоднее по биомеханике.',h1:'Сумо или классика тяга'},
    {slug:'mertvaya-tochka-v-pauerliftinge', title:'Мёртвая точка в пауэрлифтинге — что это', desc:'Мёртвая точка в приседе, жиме и тяге: где находится и как её преодолеть.',h1:'Мёртвая точка пауэрлифтинг'},
    {slug:'oshibki-v-tehnike-priseda', title:'Ошибки в технике приседа и их исправление', desc:'Частые ошибки в приседе: округление спины, колени вперёд. Упражнения для исправления.',h1:'Ошибки в технике приседа'},
    {slug:'oshibki-v-tehnike-zhima', title:'Ошибки в технике жима лёжа и их исправление', desc:'Частые ошибки в жиме: отрыв таза, отбив штанги. Упражнения для исправления техники.',h1:'Ошибки в технике жима'},
    {slug:'oshibki-v-tehnike-tyagi', title:'Ошибки в технике становой тяги', desc:'Частые ошибки в тяге: скругление спины, рывок штанги. Как исправить технику.',h1:'Ошибки в технике тяги'},
    {slug:'ekipirovka-dlya-pauerliftinga-vidy', title:'Виды экипировки для пауэрлифтинга', desc:'Комбинезон, жимовая майка, пояс, бинты — виды экипировки в пауэрлифтинге и их назначение.',h1:'Виды экипировки пауэрлифтинг'},
    {slug:'kombinezon-dlya-priseda', title:'Комбинезон для приседа — для чего нужен', desc:'Назначение комбинезона для приседа и тяги в пауэрлифтинге. Эффект упругой деформации.',h1:'Комбинезон для приседа'},
    {slug:'zhimovaya-majka-dlya-chego', title:'Жимовая майка — для чего нужна', desc:'Жимовая майка в пауэрлифтинге: как помогает пройти мёртвую точку в жиме лёжа.',h1:'Жимовая майка для чего'},
    {slug:'kpsh-v-pauerliftinge', title:'КПШ в пауэрлифтинге — что это такое', desc:'КПШ (количество подъёмов штанги) — основной показатель объёма нагрузки в тренировках.',h1:'КПШ в пауэрлифтинге'},
    {slug:'intensivnost-trenirovok-pauerlifting', title:'Интенсивность тренировок в пауэрлифтинге', desc:'Интенсивность тренировки — средний вес штанги в % от максимума. Зоны интенсивности.',h1:'Интенсивность тренировок пауэрлифтинг'},
    {slug:'mikrocikl-mezocikl-makrocikl', title:'Микроцикл, мезоцикл, макроцикл — циклы тренировок', desc:'Что такое микроцикл, мезоцикл и макроцикл в планировании тренировок пауэрлифтера.',h1:'Микроцикл мезоцикл макроцикл'},
    {slug:'planirovanie-trenirovok-pauerlifting', title:'Планирование тренировок в пауэрлифтинге', desc:'Как планировать тренировки в пауэрлифтинге: объём, интенсивность, циклирование.',h1:'Планирование тренировок пауэрлифтинг'},
    {slug:'variativnost-trenirovok', title:'Вариативность тренировок — зачем нужна', desc:'Принцип вариативности в тренировках: почему монотонная нагрузка ведёт к застою.',h1:'Вариативность тренировок'},
    {slug:'adaptacionnyj-rezerv-atleta', title:'Адаптационный резерв атлета — что это', desc:'Адаптационный резерв: способность переносить нагрузку, растёт со стажем и восстановлением.',h1:'Адаптационный резерв атлета'},
    {slug:'trenirovochnyj-i-sorevnovatelnyj-maksimum', title:'Тренировочный и соревновательный максимум', desc:'Разница между тренировочным и соревновательным (рекордным) максимумом по Зациорскому.',h1:'Тренировочный и соревновательный максимум'},
    {slug:'kak-ne-perentrenirovatsya', title:'Как не перетренироваться в пауэрлифтинге', desc:'Признаки перетренированности и как их избежать: восстановление, дыхание, циклирование.',h1:'Как не перетренироваться'},
    {slug:'nabor-myshechnoj-massy-pauerlifting', title:'Набор мышечной массы в пауэрлифтинге', desc:'Как набрать мышечную массу для перехода в весовую категорию: метод повторных усилий.',h1:'Набор мышечной массы пауэрлифтинг'},
    {slug:'kak-uderzhat-ves-v-kategorii', title:'Как удержать вес в весовой категории', desc:'Контроль веса тела перед соревнованиями: вода, а не мышцы. Советы по сгонке.',h1:'Как удержать вес в категории'},
    {slug:'programma-trenirovok-po-zhimu', title:'Программа тренировок по жиму лёжа', desc:'Раскладка программы тренировок по жиму лёжа на несколько месяцев с учётом РМ.',h1:'Программа тренировок по жиму'},
    {slug:'raskladka-po-zhimu-lezha', title:'Раскладка по жиму лёжа — расчёт весов', desc:'Онлайн раскладка по жиму лёжа: расчёт тренировочных весов от твоего ПМ.',h1:'Раскладка по жиму лёжа'},
    {slug:'rpe-shkala-v-pauerliftinge', title:'Шкала RPE в пауэрлифтинге — что это', desc:'Шкала RPE (воспринимаемое усилие) от 1 до 10 в тренировках пауэрлифтёра.',h1:'Шкала RPE пауэрлифтинг'},
    {slug:'razgruzochnaya-nedelya-pauerlifting', title:'Разгрузочная неделя в пауэрлифтинге', desc:'Зачем нужна разгрузка в тренировках: восстановление ЦНС и суставов.',h1:'Разгрузочная неделя пауэрлифтинг'},
    {slug:'zhim-s-bruskom-zachem', title:'Жим с бруском на груди — зачем нужен', desc:'Жим с бруском: специально-подготовительное упражнение для проработки мёртвой точки.',h1:'Жим с бруском зачем'},
    {slug:'prised-na-plint-zachem', title:'Присед на плинт — зачем нужен', desc:'Присед на плинт: упражнение для исправления техники и работы над глубиной.',h1:'Присед на плинт зачем'},
    {slug:'tyaga-s-ostanovkami-zachem', title:'Тяга с остановками — зачем нужна', desc:'Тяга с остановками: специально-подготовительное упражнение для силы и техники.',h1:'Тяга с остановками зачем'},
    {slug:'kak-vybrat-federaciyu-pauerlifting', title:'Как выбрать федерацию пауэрлифтинга', desc:'ФПР, WRPF, НАП, СПР — как выбрать федерацию для выступлений новичку.',h1:'Как выбрать федерацию пауэрлифтинг'},
    {slug:'chto-nuzhno-dlya-pervyh-sorevnovaniy', title:'Что нужно для первых соревнований по пауэрлифтингу', desc:'Список необходимого для первого старта: экипировка, документы, весовая категория.',h1:'Что нужно для первых соревнований'},
    {slug:'kak-poschitat-svoj-razryad', title:'Как посчитать свой разряд по пауэрлифтингу', desc:'Как узнать свой разряд по результату в жиме, приседе, тяге или сумме троеборья.',h1:'Как посчитать свой разряд'},
    {slug:'zachem-nuzhen-poyas-v-pauerliftinge', title:'Зачем нужен пояс в пауэрлифтинге', desc:'Атлетический пояс: стабилизация внутрибрюшного давления и защита поясницы.',h1:'Зачем нужен пояс пауэрлифтинг'},
    {slug:'kolennye-binty-zachem', title:'Коленные бинты — зачем нужны', desc:'Коленные бинты в пауэрлифтинге: поддержка суставов и пружинящий эффект.',h1:'Коленные бинты зачем'},
    {slug:'shtangetki-dlya-pauerliftinga', title:'Штангетки для пауэрлифтинга — зачем нужны', desc:'Специальная обувь для приседа: жёсткая подошва и устойчивость.',h1:'Штангетки для пауэрлифтинга'},
    {slug:'razminka-pered-trenirovkoj-pauerlifting', title:'Разминка перед тренировкой пауэрлифтинг', desc:'Как правильно размяться перед тяжёлой тренировкой в пауэрлифтинге.',h1:'Разминка перед тренировкой пауэрлифтинг'},
    {slug:'vosstanovlenie-posle-trenirovki-pauerlifting', title:'Восстановление после тренировки в пауэрлифтинге', desc:'Сон, питание и разгрузка для восстановления между тяжёлыми тренировками.',h1:'Восстановление после тренировки'},
    {slug:'pitanie-dlya-pauerliftera', title:'Питание для пауэрлифтера — основы', desc:'Основы питания пауэрлифтера: белки, профицит калорий, режим для роста силы.',h1:'Питание для пауэрлифтера'},
    {slug:'son-i-vosstanovlenie-sila', title:'Сон и восстановление для роста силы', desc:'Почему сон 8-9 часов критичен для роста силы и восстановления ЦНС.',h1:'Сон и восстановление сила'},
    {slug:'kak-progressirovat-v-zhime', title:'Как прогрессировать в жиме лёжа', desc:'Методы прогрессии в жиме лёжа: волновая периодизация, циклы, разгрузки.',h1:'Как прогрессировать в жиме'},
    {slug:'kak-progressirovat-v-prisede', title:'Как прогрессировать в приседе', desc:'Методы прогрессии в приседе: объём, интенсивность, техника, восстановление.',h1:'Как прогрессировать в приседе'},
    {slug:'kak-progressirovat-v-tyage', title:'Как прогрессировать в становой тяге', desc:'Методы прогрессии в становой тяге: техника, вариации упражнений, циклы.',h1:'Как прогрессировать в тяге'},
    {slug:'zastoj-v-pauerliftinge-chto-delat', title:'Застой в пауэрлифтинге — что делать', desc:'Причины застоя результатов и способы выйти из плато: вариативность, разгрузка.',h1:'Застой в пауэрлифтинге что делать'},
    {slug:'volnovaya-periodizaciya-pauerlifting', title:'Волновая периодизация в пауэрлифтинге', desc:'Что такое волновая периодизация нагрузки и зачем она нужна в тренировках.',h1:'Волновая периодизация пауэрлифтинг'},
    {slug:'linejnaya-periodizaciya-pauerlifting', title:'Линейная периодизация в пауэрлифтинге', desc:'Линейная периодизация тренировок: постепенный рост интенсивности и снижение объёма.',h1:'Линейная периодизация пауэрлифтинг'},
    {slug:'obem-i-intensivnost-trenirovki', title:'Объём и интенсивность тренировки — баланс', desc:'Как балансировать объём (КПШ) и интенсивность нагрузки в тренировочном плане.',h1:'Объём и интенсивность тренировки'},
    {slug:'tonnazh-v-pauerliftinge', title:'Тоннаж в пауэрлифтинге — что это', desc:'Тоннаж — суммарный поднятый вес за тренировку или период, измеряется в тоннах.',h1:'Тоннаж в пауэрлифтинге'},
    {slug:'chto-takoe-prohodka', title:'Что такое проходка в пауэрлифтинге', desc:'Проходка — попытка на максимум в конце тренировочного цикла. Как часто делать.',h1:'Что такое проходка'},
    {slug:'kak-chasto-delat-prohodki', title:'Как часто делать проходки на максимум', desc:'Рекомендации по частоте выхода на максимум: не чаще раза в 1-2 месяца.',h1:'Как часто делать проходки'},
    {slug:'trenirovka-cns-pauerlifting', title:'Тренировка ЦНС в пауэрлифтинге', desc:'Как тренировать нервную систему для роста максимальной силы.',h1:'Тренировка ЦНС пауэрлифтинг'},
    {slug:'vzryvnaya-sila-v-zhime', title:'Взрывная сила в жиме лёжа — как развить', desc:'Развитие взрывной силы в жиме лёжа: метод динамических усилий, лёгкие веса.',h1:'Взрывная сила в жиме'},
    {slug:'gipertrofiya-myshc-dlya-sily', title:'Гипертрофия мышц для роста силы', desc:'Как набор мышечной массы связан с ростом силы в пауэрлифтинге.',h1:'Гипертрофия мышц для роста силы'},
    {slug:'programma-trenirovok-kms-prised', title:'Программа тренировок для КМС по приседу', desc:'Как тренироваться чтобы выполнить норматив КМС по приседу со штангой.',h1:'Программа тренировок КМС присед'},
    {slug:'programma-trenirovok-kms-tyaga', title:'Программа тренировок для КМС по тяге', desc:'Как тренироваться чтобы выполнить норматив КМС по становой тяге.',h1:'Программа тренировок КМС тяга'},
    {slug:'programma-trenirovok-2-razryad', title:'Программа тренировок для 2 разряда пауэрлифтинг', desc:'Как выполнить 2 разряд по пауэрлифтингу: нормативы и подход к тренировкам.',h1:'Программа тренировок 2 разряд'},
    {slug:'programma-trenirovok-3-razryad', title:'Программа тренировок для 3 разряда пауэрлифтинг', desc:'Как выполнить 3 разряд по пауэрлифтингу для новичка.',h1:'Программа тренировок 3 разряд'},
    {slug:'skolko-nuzhno-trenirovatsya-do-kms', title:'Сколько нужно тренироваться до КМС', desc:'Примерные сроки достижения норматива КМС по пауэрлифтингу с нуля.',h1:'Сколько нужно тренироваться до КМС'},
    {slug:'skolko-nuzhno-trenirovatsya-do-ms', title:'Сколько нужно тренироваться до МС', desc:'Примерные сроки достижения норматива МС по пауэрлифтингу.',h1:'Сколько нужно тренироваться до МС'},
    {slug:'razryad-po-summe-troeborya', title:'Разряд по сумме троеборья — как считается', desc:'Как считается разряд по сумме троеборья: присед + жим + тяга.',h1:'Разряд по сумме троеборья'},
    {slug:'kak-uznat-svoj-pm', title:'Как узнать свой ПМ без прикидки', desc:'Формулы расчёта повторного максимума (ПМ) по количеству повторений с весом.',h1:'Как узнать свой ПМ'},
    {slug:'formula-rascheta-pm', title:'Формула расчёта ПМ — калькулятор', desc:'Формулы Эпли и Бжицки для расчёта повторного максимума в жиме, приседе, тяге.',h1:'Формула расчёта ПМ'},
    {slug:'wilks-vs-dots-vs-ipf-points', title:'Wilks vs DOTS vs IPF Points — сравнение формул', desc:'Сравнение формул для сравнения атлетов разных весовых категорий: Wilks, DOTS, IPF Points.',h1:'Wilks vs DOTS vs IPF Points'},
    {slug:'chto-takoe-wilks-score', title:'Что такое Wilks score в пауэрлифтинге', desc:'Wilks score — формула для сравнения силовых результатов атлетов разного веса.',h1:'Что такое Wilks score'},
    {slug:'chto-takoe-dots-score', title:'Что такое DOTS score в пауэрлифтинге', desc:'DOTS score — современная формула сравнения результатов атлетов разных категорий.',h1:'Что такое DOTS score'},
    {slug:'chto-takoe-ipf-points', title:'Что такое IPF Points', desc:'IPF Points — официальная формула Международной федерации пауэрлифтинга.',h1:'Что такое IPF Points'},
    {slug:'nachat-zanimatsya-pauerliftingom', title:'С чего начать заниматься пауэрлифтингом', desc:'Пошаговый гайд для новичка: техника, программа, экипировка, первые соревнования.',h1:'С чего начать пауэрлифтинг'},
    {slug:'pauerlifting-dlya-nachinayushchih-zhenshchin', title:'Пауэрлифтинг для начинающих женщин', desc:'Как начать заниматься пауэрлифтингом девушке: техника, программа, нормативы.',h1:'Пауэрлифтинг для начинающих женщин'},
    {slug:'pauerlifting-posle-30-let', title:'Пауэрлифтинг после 30 лет — с чего начать', desc:'Особенности начала занятий пауэрлифтингом в зрелом возрасте.',h1:'Пауэрлифтинг после 30 лет'},
    {slug:'skolko-vesit-shtanga-i-blinov', title:'Сколько весит гриф и блины на штанге', desc:'Стандартные веса грифа и блинов для приседа, жима и тяги в пауэрлифтинге.',h1:'Сколько весит гриф и блины'},
    {slug:'razmery-pomosta-dlya-pauerliftinga', title:'Размеры помоста для пауэрлифтинга', desc:'Официальные размеры соревновательного помоста по правилам IPF.',h1:'Размеры помоста для пауэрлифтинга'},
    {slug:'pravila-sudeystva-v-pauerliftinge', title:'Правила судейства в пауэрлифтинге', desc:'Как судьи оценивают попытки в приседе, жиме и тяге. Красный и белый свет.',h1:'Правила судейства пауэрлифтинг'},
    {slug:'skolko-popytok-na-sorevnovaniyah', title:'Сколько попыток даётся на соревнованиях', desc:'Правила количества попыток в каждом упражнении на соревнованиях по пауэрлифтингу.',h1:'Сколько попыток на соревнованиях'},
    {slug:'kak-zapisatsya-na-sorevnovaniya-pauerlifting', title:'Как записаться на соревнования по пауэрлифтингу', desc:'Порядок регистрации на первые соревнования: федерация, документы, взнос.',h1:'Как записаться на соревнования'},
    {slug:'chto-takoe-vsm-v-sporte', title:'Что такое ВСМ в спорте — расшифровка', desc:'ВСМ — группа высшего спортивного мастерства. Расшифровка термина.',h1:'Что такое ВСМ в спорте'},
    {slug:'chto-takoe-utg-v-sporte', title:'Что такое УТГ в спорте — расшифровка', desc:'УТГ — учебно-тренировочная группа. Расшифровка спортивного термина.',h1:'Что такое УТГ в спорте'},
    {slug:'gruppa-nachalnoy-podgotovki', title:'Группа начальной подготовки — что это', desc:'ГНП — группа начальной подготовки в спортивной школе. Задачи и особенности.',h1:'Группа начальной подготовки'},
    {slug:'razryady-po-godam-sporta', title:'Как меняются разряды по годам в спорте', desc:'Периодичность пересмотра ЕВСК и нормативов по видам спорта.',h1:'Разряды по годам спорта'},
    {slug:'evsk-2022-2026-rasshifrovka', title:'ЕВСК 2022-2026 — расшифровка аббревиатуры', desc:'ЕВСК — Единая всероссийская спортивная классификация. Период действия 2022-2026.',h1:'ЕВСК 2022-2026 расшифровка'},
    {slug:'kak-poluchit-zvanie-ms', title:'Как получить звание МС по пауэрлифтингу', desc:'Порядок присвоения звания мастера спорта: результат, протокол, подача документов.',h1:'Как получить звание МС'},
    {slug:'kak-poluchit-zvanie-msmk', title:'Как получить звание МСМК по пауэрлифтингу', desc:'Требования для присвоения звания мастера спорта международного класса.',h1:'Как получить звание МСМК'},
    {slug:'razlichiya-ekipirovannogo-i-klassicheskogo-lifta', title:'Различия экипированного и классического лифтинга', desc:'В чём разница между классическим (безэкипировочным) и экипированным пауэрлифтингом.',h1:'Экипированный vs классический лифтинг'},
    {slug:'chto-daet-ekipirovka-v-kg', title:'Сколько килограммов даёт экипировка', desc:'Насколько экипировка увеличивает результат в приседе, жиме и тяге.',h1:'Сколько килограммов даёт экипировка'},
    {slug:'pervyj-god-trenirovok-pauerlifting', title:'Первый год тренировок в пауэрлифтинге', desc:'Чего ожидать от прогресса в первый год занятий пауэрлифтингом.',h1:'Первый год тренировок пауэрлифтинг'},
    {slug:'progress-v-pauerliftinge-po-godam', title:'Прогресс в пауэрлифтинге по годам', desc:'Как меняется скорость прогресса в силе в зависимости от стажа тренировок.',h1:'Прогресс в пауэрлифтинге по годам'},
    {slug:'genetika-i-sila-v-pauerliftinge', title:'Генетика и сила в пауэрлифтинге', desc:'Насколько результат в пауэрлифтинге зависит от генетики и типа телосложения.',h1:'Генетика и сила пауэрлифтинг'},
    {slug:'tip-telosplozheniya-dlya-pauerliftinga', title:'Тип телосложения для пауэрлифтинга', desc:'Какой тип телосложения выгоднее для приседа, жима и тяги.',h1:'Тип телосложения для пауэрлифтинга'},
    {slug:'dlina-ruk-i-nog-v-pauerliftinge', title:'Длина рук и ног в пауэрлифтинге — влияние', desc:'Как антропометрия (длина конечностей) влияет на технику и результат в лифтах.',h1:'Длина рук и ног в пауэрлифтинге'},
    {slug:'shirokij-ili-uzkij-hvat-zhim', title:'Широкий или узкий хват в жиме лёжа', desc:'Сравнение широкого и узкого хвата в жиме лёжа: амплитуда, включаемые мышцы.',h1:'Широкий или узкий хват жим'},
    {slug:'glubina-priseda-po-pravilam', title:'Глубина приседа по правилам IPF', desc:'Требования к глубине приседа на соревнованиях по правилам IPF.',h1:'Глубина приседа по правилам'},
    {slug:'pauza-v-zhime-skolko-sekund', title:'Пауза в жиме лёжа — сколько секунд', desc:'Требования к паузе на груди в жиме лёжа по правилам соревнований.',h1:'Пауза в жиме сколько секунд'},
    {slug:'diskvalifikaciya-na-sorevnovaniyah', title:'Дисквалификация на соревнованиях по пауэрлифтингу', desc:'Причины дисквалификации попытки: отбив, недосед, отрыв таза и другие нарушения.',h1:'Дисквалификация на соревнованиях'},
    {slug:'krasnyj-i-belyj-svet-sudej', title:'Красный и белый свет судей в пауэрлифтинге', desc:'Система судейства попыток: три судьи, красный и белый свет, засчитанная попытка.',h1:'Красный и белый свет судей'},
    {slug:'vzveshivanie-pered-sorevnovaniyami', title:'Взвешивание перед соревнованиями по пауэрлифтингу', desc:'Правила и время взвешивания перед стартом на соревнованиях.',h1:'Взвешивание перед соревнованиями'},
    {slug:'razminka-v-den-sorevnovaniy', title:'Разминка в день соревнований пауэрлифтинг', desc:'Как правильно размяться и распределить попытки в день старта.',h1:'Разминка в день соревнований'},
    {slug:'kak-vybrat-nachalnyj-ves-na-sorevnovaniyah', title:'Как выбрать начальный вес на соревнованиях', desc:'Стратегия выбора первой попытки на соревнованиях по пауэрлифтингу.',h1:'Как выбрать начальный вес'},
    {slug:'strategiya-popytok-na-sorevnovaniyah', title:'Стратегия попыток на соревнованиях', desc:'Как распределить три попытки в приседе, жиме и тяге для максимального результата.',h1:'Стратегия попыток на соревнованиях'},
    {slug:'kak-borotsya-s-volneniem-pered-startom', title:'Как бороться с волнением перед стартом', desc:'Советы по психологической подготовке к соревнованиям по пауэрлифтингу.',h1:'Как бороться с волнением перед стартом'},
    {slug:'trener-po-pauerliftingu-kak-vybrat', title:'Как выбрать тренера по пауэрлифтингу', desc:'На что обратить внимание при выборе тренера для занятий пауэрлифтингом.',h1:'Как выбрать тренера по пауэрлифтингу'},
    {slug:'samostoyatelnye-trenirovki-pauerlifting', title:'Самостоятельные тренировки по пауэрлифтингу', desc:'Можно ли тренироваться без тренера: программа, техника, самоконтроль.',h1:'Самостоятельные тренировки пауэрлифтинг'},
    {slug:'domashnie-trenirovki-pauerlifting', title:'Домашние тренировки по пауэрлифтингу', desc:'Можно ли тренировать присед, жим и тягу дома. Минимальный инвентарь.',h1:'Домашние тренировки пауэрлифтинг'},
    {slug:'minimalnyj-inventar-dlya-pauerliftinga', title:'Минимальный инвентарь для пауэрлифтинга', desc:'Что нужно для начала тренировок: штанга, стойки, скамья, диски.',h1:'Минимальный инвентарь пауэрлифтинг'},
    {slug:'kak-vybrat-zal-dlya-pauerliftinga', title:'Как выбрать зал для пауэрлифтинга', desc:'На что обратить внимание при выборе зала: стойки, помост, штанги.',h1:'Как выбрать зал для пауэрлифтинга'},
    {slug:'travmy-v-pauerliftinge-profilaktika', title:'Травмы в пауэрлифтинге — профилактика', desc:'Частые травмы в пауэрлифтинге и способы их профилактики через технику и разминку.',h1:'Травмы в пауэрлифтинге профилактика'},
    {slug:'bol-v-poyasnice-posle-priseda', title:'Боль в пояснице после приседа — причины', desc:'Возможные причины боли в пояснице после тренировки приседа и способы их устранения.',h1:'Боль в пояснице после приседа'},
    {slug:'bol-v-pleche-posle-zhima', title:'Боль в плече после жима лёжа — причины', desc:'Возможные причины боли в плече после жима и техника для её предотвращения.',h1:'Боль в плече после жима'},
    {slug:'razminka-plech-pered-zhimom', title:'Разминка плеч перед жимом лёжа', desc:'Упражнения для разминки плечевых суставов перед тяжёлым жимом.',h1:'Разминка плеч перед жимом'},
    {slug:'podsobka-dlya-zhima-lezha', title:'Подсобные упражнения для жима лёжа', desc:'Лучшие подсобные упражнения для роста жима: трицепс, грудные, плечи.',h1:'Подсобка для жима лёжа'},
    {slug:'podsobka-dlya-priseda', title:'Подсобные упражнения для приседа', desc:'Лучшие подсобные упражнения для роста приседа: квадрицепс, ягодицы, кор.',h1:'Подсобка для приседа'},
    {slug:'podsobka-dlya-tyagi', title:'Подсобные упражнения для становой тяги', desc:'Лучшие подсобные упражнения для роста тяги: спина, бицепс бедра, хват.',h1:'Подсобка для тяги'},
    {slug:'trenirovka-hvata-dlya-tyagi', title:'Тренировка хвата для становой тяги', desc:'Упражнения для укрепления хвата: важность в становой тяге на больших весах.',h1:'Тренировка хвата для тяги'},
    {slug:'lyamki-ili-hvat-v-zamok', title:'Лямки или хват в замок в тяге', desc:'Сравнение способов хвата в становой тяге: разнохват, лямки, хват в замок.',h1:'Лямки или хват в замок'},
    {slug:'razgibaniya-spiny-dlya-tyagi', title:'Гиперэкстензии для становой тяги', desc:'Как гиперэкстензии помогают в развитии силы разгибателей спины для тяги.',h1:'Гиперэкстензии для тяги'},
    {slug:'kak-uvelichit-zhim-lezha-bystro', title:'Как быстро увеличить жим лёжа', desc:'Реалистичные способы ускорить прогресс в жиме лёжа без риска травм.',h1:'Как быстро увеличить жим лёжа'},
    {slug:'kak-uvelichit-prised-bystro', title:'Как быстро увеличить присед', desc:'Реалистичные способы ускорить прогресс в приседе со штангой.',h1:'Как быстро увеличить присед'},
    {slug:'kak-uvelichit-stanovuyu-tyagu', title:'Как увеличить становую тягу', desc:'Способы прогрессии в становой тяге: техника, объём, подсобка.',h1:'Как увеличить становую тягу'},
    {slug:'plato-v-zhime-lezha-chto-delat', title:'Плато в жиме лёжа — что делать', desc:'Причины остановки прогресса в жиме и способы выйти из застоя.',h1:'Плато в жиме лёжа что делать'},
    {slug:'kalkulyator-1pm-zhim', title:'Калькулятор 1ПМ жим лёжа онлайн', desc:'Расчёт разового максимума в жиме лёжа по весу и количеству повторений.',h1:'Калькулятор 1ПМ жим'},
    {slug:'kalkulyator-1pm-prised', title:'Калькулятор 1ПМ присед онлайн', desc:'Расчёт разового максимума в приседе по весу и количеству повторений.',h1:'Калькулятор 1ПМ присед'},
    {slug:'kalkulyator-1pm-tyaga', title:'Калькулятор 1ПМ становая тяга онлайн', desc:'Расчёт разового максимума в становой тяге по весу и количеству повторений.',h1:'Калькулятор 1ПМ тяга'},
    {slug:'procenty-ot-pm-tablitsa', title:'Проценты от ПМ — таблица весов', desc:'Таблица процентов от повторного максимума для планирования тренировочных весов.',h1:'Проценты от ПМ таблица'},
    {slug:'skolko-otdyhat-mezhdu-podhodami', title:'Сколько отдыхать между подходами в пауэрлифтинге', desc:'Рекомендации по времени отдыха между подходами при силовой работе.',h1:'Сколько отдыхать между подходами'},
    {slug:'kolichestvo-podhodov-na-uprazhnenie', title:'Сколько подходов делать на упражнение', desc:'Оптимальное количество подходов для роста силы в базовых упражнениях.',h1:'Количество подходов на упражнение'},
    {slug:'zachem-nuzhna-tehnika-v-pauerliftinge', title:'Зачем нужна техника в пауэрлифтинге', desc:'Почему правильная техника важнее веса на штанге для долгосрочного прогресса.',h1:'Зачем нужна техника в пауэрлифтинге'},
    {slug:'video-analiz-tehniki-pauerlifting', title:'Видеоанализ техники в пауэрлифтинге', desc:'Как использовать видеосъёмку для анализа и улучшения техники подъёмов.',h1:'Видеоанализ техники пауэрлифтинг'},
    {slug:'biomehanika-priseda-v-pauerliftinge', title:'Биомеханика приседа в пауэрлифтинге', desc:'Особенности биомеханики приседа: траектория штанги, углы в суставах.',h1:'Биомеханика приседа пауэрлифтинг'},
    {slug:'biomehanika-zhima-v-pauerliftinge', title:'Биомеханика жима лёжа', desc:'Особенности биомеханики жима лёжа: траектория штанги, работа плечевого пояса.',h1:'Биомеханика жима лёжа'},
    {slug:'biomehanika-tyagi-v-pauerliftinge', title:'Биомеханика становой тяги', desc:'Особенности биомеханики становой тяги: центр тяжести, углы в суставах.',h1:'Биомеханика становой тяги'},
  ];
